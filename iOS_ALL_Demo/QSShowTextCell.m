...
- (UILabel *)titleLabel{
    ...
    if (!_titleLabel) {
        ...
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 15, ScreenWidth - 30, 16)];
...
- (UILabel *)contentLabel{
    ...
    if (!_contentLabel) {
        ...
        _contentLabel.qsConstrainedWidth = ScreenWidth - 30;
...
+ (CGFloat)cellHeightWithModel:(QSShowTextCellModel *)model{
    ...
    CGSize textSize = [model.content textSizeWithFont:[UIFont systemFontOfSize:QSTextFontSize] numberOfLines:model.contentLines lineSpacing:QSTextLineSpacing constrainedWidth:ScreenWidth - 30 isLimitedToLines:&isLimitedToLines];
